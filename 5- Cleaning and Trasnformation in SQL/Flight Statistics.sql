USE master;
DROP DATABASE IF EXISTS CleaningData;
GO
...
/*
We will be working with a dataset based on monthly airline flights in USA airports, registered in the years 2014 and 2015.
It contains information about airports,carriers,flight statistics,and pilots.
*/
